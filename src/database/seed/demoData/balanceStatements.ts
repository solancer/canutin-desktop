...
export const accountRothIraBalanceStatements = [
  ...
  {
    createdAt: getUnixTime(subMonths(new Date(), 19)),
    value: 13535.98,
  },
  {
    createdAt: getUnixTime(subMonths(new Date(), 21)),
    value: 13035.75,
  },
  {
    createdAt: getUnixTime(subMonths(new Date(), 23)),
    value: 12535.45,
  },
  {
    createdAt: getUnixTime(subMonths(new Date(), 25)),
    value: 12035.38,
  },
];
...
export const accountWalletBalanceStatements = [
  ...
  {
    createdAt: getUnixTime(subMonths(new Date(), 18)),
    value: 700,
  },
];
